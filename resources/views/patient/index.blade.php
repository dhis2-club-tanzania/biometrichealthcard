<x-app-layout>
    ...
    <div class=" flex items-center justify-between py-2 px-8">
        <div>
			<h2 class="text-gray-600 font-semibold"> Patient's fingerprints</h2>
			<span class="text-xs">All patients fingerprints details</span>
		</div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-wrap">
                    <div class="w-full p-4">
                        <h2 class="text-2xl font-bold mb-4">Patients Table</h2>
                        @if(session('message'))
                                    ...
                                    <a href="{{ route('patients.show',$patient->id) }}">
                                      ...
                                      <form method="POST" action="{{ route('patients.destroy',$patient->id) }}">
                                          ...
                                          <span class="relative inline-block px-2 py-1 font-semibold text-red-600 leading-tight">
                                              <a href="{{ route('patients.destroy',$patient->id) }}" onclick="event.preventDefault(); this.closest('form').submit();">
