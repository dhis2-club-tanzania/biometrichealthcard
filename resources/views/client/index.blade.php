                        ...
                        <form method="POST" action="{{ route('clients.store') }}">
                            @csrf
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="patient_id" class="block mt-1 w-full" type="text" name="patient_id" :value="old('patient_id')" required />
                               ...
                               <div class="mt-4">
                                   ...
                                   <x-text-input id="cardNo" class="block mt-1 w-full" type="text" name="cardNo" :value="old('cardNo')" required autofocus />
